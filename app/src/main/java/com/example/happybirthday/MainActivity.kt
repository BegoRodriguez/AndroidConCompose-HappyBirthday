...
fun GreetingImage(message: String, from: String, modifier: Modifier = Modifier) {
    ...
    Box(modifier){
        Image(
            ...
            contentScale = ContentScale.Crop, // ajusta la escala de la imagen de manera uniforme para mantener la relación de aspecto
            alpha = 0.5F // Para cambiar la opacidad
        )
        GreetingText(
            message = message,
            from = from,
